package com.uzdz.license.license;
...
public abstract class AbstractServerInfos {
    ...
    public LicenseCheckModel getServerInfos(){
        ...
        try {
            ...
            result.setCpuSerial(Arrays.asList(this.getCPUSerial()));
            result.setMainBoardSerial(Arrays.asList(this.getMainBoardSerial()));
        }catch (Exception e){
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(localAllInetAddress);
    }
